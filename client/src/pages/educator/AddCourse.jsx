      ...
      >
        ...
        <div className="flex items-center justify-between flex-wrap gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            >
              ...
              />
              {image && (
                <img className="max-h-10" src={URL.createObjectURL(image)} />
              )}
            </label>
          </div>
        </div>
        ...
        {showPopup && (
          <div className="fixed inset-0 flex items-center justify-center z-50">
            <div className="bg-white text-gray-700 p-4 rounded relative w-full max-w-sm shadow-2xl">
        ...
        <button
          className="w-max bg-blue-500 text-white px-8 py-2.5 rounded my-4"
          type="submit"
        >
          Add
        </button>
